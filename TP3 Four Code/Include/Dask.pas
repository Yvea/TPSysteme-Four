...
function DI_7360_Config (CardNumber:Word; DIPortWidth:Word; DIMode:Word; DIWaitStatus:Word; DIClkConfig:Word):Smallint;stdcall;
function DI_7360_ExportSampCLKConfig (CardNumber:Word; CLK_Src:Word; CLK_DPAMode:Word; CLK_DPAVlaue:Word):Smallint;stdcall;
function DI_7360_ExtSampCLKConfig (CardNumber:Word; CLK_Src:Word; CLK_DDAMode:Word; CLK_DPAMode:Word; CLK_DDAVlaue:Word; CLK_DPAVlaue:Word):Smallint;stdcall;
function DI_7360_SoftTriggerGen (CardNumber:Word):Smallint;stdcall;
function DI_7360_TrigHSConfig (CardNumber:Word; TrigConfig:Word; DI_IPOL:Word; DI_REQSrc:Word; DI_ACKSrc:Word; DI_TRIGSrc:Word; StartTrigSrc:Word; PauseTrigSrc:Word; SoftTrigOutSrc:Word; SoftTrigOutLength:Cardinal; TrigCount:Cardinal):Smallint;stdcall;
function DI_7360_BurstHandShakeDelay (CardNumber:Word; Delay:Byte):Smallint;stdcall;
(*---------------------------------------------------------------------------*)
...
function DO_7360_Config (CardNumber:Word; DOPortWidth:Word; DOMode:Word; DOWaitStatus:Word; DOClkConfig:Word):Smallint;stdcall;
function DO_7360_TrigHSConfig (CardNumber:Word; TrigConfig:Word; DO_IPOL:Word; DO_REQSrc:Word; DO_ACKSrc:Word; DO_TRIGSrc:Word; StartTrigSrc:Word; PauseTrigSrc:Word; SoftTrigOutSrc:Word; SoftTrigOutLength:Cardinal; TrigCount:Cardinal):Smallint;stdcall;
function DO_7360_ExtSampCLKConfig (CardNumber:Word; CLK_Src:Word; CLK_DDAMode:Word; CLK_DPAMode:Word; CLK_DDAVlaue:Word; CLK_DPAVlaue:Word):Smallint;stdcall;
function DO_7360_ExportSampCLKConfig (CardNumber:Word; CLK_Src:Word; CLK_Mode:Word; CLK_DPAMode:Word; CLK_DPAVlaue:Word):Smallint;stdcall;
function DO_7360_SoftTriggerGen (CardNumber:Word):Smallint;stdcall;
function DO_7360_BurstHandShakeDelay (CardNumber:Word; Delay:Byte):Smallint;stdcall;
(*---------------------------------------------------------------------------*)
